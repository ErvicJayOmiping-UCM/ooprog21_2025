...
str = in.nextLine();
length = str.length();//There is no len() the correct is length
for(x = 0; x < length; ++x)//same you declare the len instead of legnth
{
if(str.charAt(x) == ' ')
{
...
num = Integer.parseInt(partStr);//Should be partStr
System.out.println(" " + num);
sum += num;//should be added + cause its a su
System.out.println(" -------------------" +
